        ...
        1: [
            function(a, b) {
                var c = (a("./modules/polyfills"), a("./modules/svg-injector")),
                    ...
                    h = a("./modules/log"),
                    i = {}, j = window.iconicSmartIconApis = {}, k = ("file:" === window.location.protocol, 0),
                    l = function(a, b, e) {
                        b = d({}, i, b || {});
                        var f = {
                    ...
                    return {
                        ...
                        link: function(scope, element, attrs) {
                            ...
                            if ((!svgAttrExpressions.SVG_ELEMENT.test(element[0] &&
                                element[0].toString())) || !$location.$$html5 || !$sniffer.history) return;
